...
COLOR_UNIVERSE = (20, 20, 20) # Slightly darker universe 
COLOR_SUN = (255, 180, 20) # Deeper orange-yellow
COLOR_MERCURY = (130, 110, 100)  # Warmer brown
COLOR_VENUS = (230, 180, 50) # Muted yellow-orange
COLOR_EARTH = (50, 100, 175) # Deeper blue
COLOR_MARS = (170, 50, 0) # Richer red-brown
COLOR_JUPITER = (200, 160, 100) # Warmer beige tones
COLOR_SATURN = (170, 220, 140) 
COLOR_URANUS = (140, 200, 200) # Deeper blue-green
COLOR_NEPTUNE = (40, 60, 150) # Deeper blue
...
class Planet:
    ...
    def update_position(self, planets):
        ...
        self.orbit.append((self.x, self.y))  # Add orbit point

        # Control how often points are added 
        if len(self.orbit) > 100:  
            self.orbit.pop(0)  # Remove older points
...
def main():
    ...
    while run:
        ...
        text_surface = FONT_1.render("X", True, COLOR_WHITE)
